...
#define LEDx_GPIO_CLK_ENABLE(__INDEX__)   (((__INDEX__) == 0) ? LED0_GPIO_CLK_ENABLE() :\
                                           ((__INDEX__) == 1) ? LED1_GPIO_CLK_ENABLE() :\
                                           ((__INDEX__) == 2) ? LED2_GPIO_CLK_ENABLE() : LED3_GPIO_CLK_ENABLE())

#define LEDx_GPIO_CLK_DISABLE(__INDEX__)  (((__INDEX__) == 0) ? LED0_GPIO_CLK_DISABLE() :\
                                           ((__INDEX__) == 1) ? LED1_GPIO_CLK_DISABLE() :\
                                           ((__INDEX__) == 2) ? LED2_GPIO_CLK_DISABLE() : LED3_GPIO_CLK_DISABLE())
